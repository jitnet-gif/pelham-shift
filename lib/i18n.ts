...
const en: Record<string, string> = {
  ...
  '교육 자료를 직원에게 배정하고 이수 여부를 확인하는 기능을 준비하고 있습니다.': 'Assign training material to staff and track completion.',
  '지원자를 등록하고 면접·채용 단계를 관리하는 기능을 준비하고 있습니다.': 'Track applicants through interviews and hiring stages.',
  ...
  '예정 합계': 'Scheduled',
  '경고 {n}건': '{n} warnings',
  '확인이 필요한 대체근무 요청': 'Swap request needs review',
